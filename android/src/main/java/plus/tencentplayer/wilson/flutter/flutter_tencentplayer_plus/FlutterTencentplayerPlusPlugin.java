...
public class FlutterTencentplayerPlusPlugin implements MethodCallHandler {
  ...
  private static class TencentPlayer implements ITXVodPlayListener {
    ...
    TencentPlayer(Registrar mRegistrar, EventChannel eventChannel, TextureRegistry.SurfaceTextureEntry textureEntry,
    ...
    private void setPlayConfig(MethodCall call) {
      ...
      if (call.argument("cachePath") != null) {
        mPlayConfig.setCacheFolderPath(call.argument("cachePath").toString());// mPlayConfig.setCacheFolderPath(Environment.getExternalStorageDirectory().getPath()
                                                                              // + "/nellcache");
    ...
    private void setFlutterBridge(EventChannel eventChannel, TextureRegistry.SurfaceTextureEntry textureEntry,
        Result result) {
  ...
  class TencentDownload implements ITXVodDownloadListener {
    ...
    TencentDownload(Registrar mRegistrar, EventChannel eventChannel, MethodCall call, Result result) {
      this.eventChannel = eventChannel;
      this.mRegistrar = mRegistrar;
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    case "create":
      ...
      EventChannel eventChannel = new EventChannel(registrar.messenger(),
          "flutter_tencentplayer/videoEvents" + handle.id());
    ...
    case "download":
      String urlOrFileId = call.argument("urlOrFileId").toString();
      EventChannel downloadEventChannel = new EventChannel(registrar.messenger(),
          "flutter_tencentplayer/downloadEvents" + urlOrFileId);
